...
export default async function handler(req, res) {
  ...
  const systemParts = [
    ...
    'IMPORTANTE sobre salario_ref en cargos_hoy: estimalo con tu criterio del mercado chileno actual (sin necesidad de buscar en internet, para no demorar la respuesta). Presentalo SIEMPRE explicitamente como una estimacion referencial aproximada, nunca como una cifra exacta o confirmada.',
