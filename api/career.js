...
export default async function handler(req, res) {
  ...
  const systemParts = [
    ...
    'IMPORTANTE sobre salario_ref en cargos_hoy: usa TAMBIEN la herramienta de busqueda web para fundamentar los rangos salariales — busca sueldos actuales y reales para esos cargos en el mercado chileno (ofertas publicadas, portales de empleo, estudios salariales recientes), en vez de estimarlos solo de memoria. Si encuentras cifras reales y actuales, usalas como base del rango. Si no encuentras datos suficientes para un cargo especifico, dilo explicitamente como una estimacion referencial (nunca presentes una cifra inventada como si fuera un dato confirmado).',
